...
const sizes: Record<Size, string> = {
  ...
  small:
    "px-[18px] py-5 rounded-[18px] bg-violet-blue hover:bg-periwinkle hover:text-raisin-black duration-300 transition-all text-white uppercase text-base font-semibold text-raisin-black",
};
